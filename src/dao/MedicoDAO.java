...
/**
 * DAO de Medico - responsável por salvar e carregar
 * a lista de médicos em arquivo binário (serialização).
 */
public class MedicoDAO {

    private static final String ARQUIVO = "data/medicos.dat";

    // Salva a lista de médicos no arquivo
    ...
    // Carrega a lista de médicos do arquivo
